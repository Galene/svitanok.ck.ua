...
\*======================================================================*/
if ($show_tools == 1):
	include TEMPLATEPATH.DS."yjsgcore/yjsg_tools.php";/* site tools , font resizer , rtl switch */
endif;
?>
<!-- footer -->
<div id="footer"  style="font-size:<?php echo $css_font; ?>; width:<?php echo $css_width.$css_widthdefined; ?>;">
  <div id="youjoomla">
	...
	<?php if (!preg_match("/iphone/i",$who)){ ?>
    	<div id="cp">
		<?php echo getYJLINKS($default_font_family,$yj_copyrightear,$yj_templatename,$show_tools,$show_fres,$show_rtlc)  ?>
